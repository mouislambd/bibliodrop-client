      ...
      <div className="bg-white p-8 rounded-xl shadow-md text-center max-w-md">
        ...
        {status === "success" && (
          <>
            ...
            <Link href="/dashboard/user" className="bg-primary text-white px-6 py-3 rounded-lg hover:bg-secondary transition">
              Go to Dashboard
            </Link>
          </>
        )}
        {status === "error" && (
          <>
            ...
            <Link href="/books" className="bg-primary text-white px-6 py-3 rounded-lg hover:bg-secondary transition">
              Browse Books
            </Link>
          </>
        )}
