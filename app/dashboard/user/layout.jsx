...
import {
    FiGrid, FiTruck, FiBookOpen, FiStar, FiMenu, FiX, FiHeart,
} from "react-icons/fi";
import { useState } from "react";

const links = [
    { href: "/dashboard/user", label: "Overview", icon: <FiGrid /> },
    { href: "/dashboard/user/history", label: "Delivery History", icon: <FiTruck /> },
    { href: "/dashboard/user/reading-list", label: "Reading List", icon: <FiBookOpen /> },
    { href: "/dashboard/user/reviews", label: "My Reviews", icon: <FiStar /> },
    { href: "/dashboard/user/wishlist", label: "Wishlist", icon: <FiHeart /> },
];
    ...
    return (
      ...
      `}>
                ...
                <div className="p-6 border-b border-gray-700">
                    ...
                    <p className="text-gray-400 text-xs">Reader</p>
                </div>
